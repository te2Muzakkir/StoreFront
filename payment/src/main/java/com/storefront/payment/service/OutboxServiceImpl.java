...
public class OutboxServiceImpl implements OutboxService {
    ...
    public List<OutboxEvent> claimEvents() {
        List<OutboxEvent> events = outboxEventRepository
        		.findTop100ForUpdate(PaymentConstants.OUTBOX_STATUS_PENDING, PageRequest.of(0, 100));
	...
	public String retryFailed() {
		List<OutboxEvent> failedEvents = outboxEventRepository.findByStatus(PaymentConstants.OUTBOX_STATUS_FAILED);
